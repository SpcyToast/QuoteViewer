...
object QuotesData {
    val dailyQuotes= listOf<Quote>(
        ...
        Quote("If you believe it will work, you'll see opportunities. If you believe it won't, you will see obstacles.", "Wayne Dyer"),
        ...
        Quote("It's not just about being better. It's about being different. You need to give people a reason to choose your business.", "Tom Abbott"),
        ...
        Quote("Follow your bliss and the universe will open doors where there are only walls.", "Joseph Campbell"),
        ...
        Quote("The way a team plays as a whole determines its success. You may have the greatest bunch of individual stars in the world, but if they don't play together, the club won't be worth a dime.", "Babe Ruth"),
        Quote("It is amazing what you can accomplish if you do not care who gets the credit.", "Harry Truman"),
        Quote("I can do things you cannot, you can do things I cannot: together we can do great things.", "Mother Teresa"),
        Quote("Try to be a rainbow in someone's cloud.", "Maya Angelou"),
        Quote("It is the long history of humankind (and animal kind, too) that those who learned to collaborate and improvise most effectively have prevailed.", "Charles Darwin"),
        ...
        Quote("It is important to look at death because it is a part of life. It is a sad thing, melancholy but romantic at the same time. It is the end of a cycle - everything has to end. The cycle of life is positive because it gives room for new things.", "Alexander McQueen"),
